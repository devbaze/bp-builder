...
class CommandMake extends Command
{
    ...
    {
        return __DIR__ . '/stubs/builder/Script.js';
    }
    ...
    protected function updateStub($stub, $name)
    {
        ...
        $stub = str_replace('BuilderNameDashes', $name_dashes, $stub);
        $stub = str_replace('BuilderNameUnderscores', $name_underscores, $stub);
        $stub = str_replace('BuilderNameCap', $name, $stub);
        return $stub;
    }
